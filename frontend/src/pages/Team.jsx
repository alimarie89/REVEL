...
function Team() {
  ...
  // Talent - ~20 people
  const talent = [
    { id: 101, name: 'Featured Talent 1', role: 'Facilitator', bio: 'Bio to come', photo: '/team/placeholder.jpg' },
    { id: 102, name: 'Featured Talent 2', role: 'Artist', bio: 'Bio to come', photo: '/team/placeholder.jpg' },
